function TitleCard () {
    return <div>
        <div className="flex p-1 border-none bg-slate-100 m-2 rounded-sm place-content-between ">
            <div className="flex">
            <div className="w-4 items-canter">
            ...
            <div className="text-xs items-center mx-2 ">
            Monday, 14 Octuber 2024
            </div>
            <div>
            ...
            <div className="flex px-2 mx-2">
                {/* long-left-arrow */}
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-5" onClick={() => console.log("hi")}>
...
// flex p-1 border-b-1 border-slate-300 m-2